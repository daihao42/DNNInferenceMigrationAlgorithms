...
public class Online_old {
    ...
    public Online_old(BigDecimal lambda,BigDecimal beta, List<Requests.Request> request_list,int precision){
        this.lambda = lambda;
        this.beta = beta;
